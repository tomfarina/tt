...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Day = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				'li',
				{ id: this.state.liId, style: { display: 'inline-block', padding: 10 } },
				React.createElement(
					'h4',
					null,
					this.props.name
	...
	var UpdateTaskModal = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				{ id: "UpdateTaskModal" },
				"name: ",
				React.createElement("input", { type: "text", ref: "newName", defaultValue: this.state.name }),
				"hours: ",
				React.createElement("input", { type: "text", ref: "newHours", defaultValue: this.state.hours }),
				React.createElement(
					"button",
					{ onClick: function () {
							return _this.props.clickFunction(_this.props.task.id, _this.refs.newName.value, _this.refs.newHours.value);
						} },
					"update"
				),
				React.createElement(
